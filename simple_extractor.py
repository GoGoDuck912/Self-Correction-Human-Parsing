...
# Skirt: Váy ngắn
# Belt: Nịt
# Torso: Phần thân (không chứa đầu, tay)
...
def main():
    ...
    with torch.no_grad():
        for idx, batch in enumerate(tqdm(dataloader)):
            ...
            index = dataset_settings[args.dataset]['label'].index('Face')
            parsing_result[np.where(parsing_result == 11)] = 255
